...
class Test extends TestCase
{
    ...
    {
        // when
        $replaced = Pattern::of('\d+')->replace('127.0.0.1')->with('X');
        // then
    ...
    {
        // when
        $replaced = Pattern::of('\d+')->replace('127.0.0.1')->with('$1');
        // then
    ...
    {
        // when
        $replaced = Pattern::of('\d+')->replace('127.0.0.1')->with('$0');
        // then
    ...
    {
        // when
        $replaced = Pattern::of('er|ab|ay')->replace('P. Sherman, 42 Wallaby way, Sydney')->with('<${0}>');
        // then
    ...
    {
        // when
        $replaced = Pattern::of('er|ab|ay')->replace('P. Sherman, 42 Wallaby way, Sydney')->with('<${11}>');
        // then
    ...
    {
        // when
        $replaced = Pattern::of('er|ab|ay')->replace('P. Sherman, 42 Wallaby way, Sydney')->with('<${00}>');
        // then
    ...
    {
        // when
        $replaced = Pattern::of('\d+')->replace('127.0.0.1')->with('\11');
        // then
    ...
    {
        // when
        $replaced = Pattern::of('er|ay|ey')->replace('P. Sherman, 42 Wallaby way, Sydney')->with('\\\\');
        // then
    ...
    public function shouldThrowForMalformedPattern()
    {
        ...
        // when
        Pattern::of('?')->replace('Foo')->limit(0)->with('Bar');
    }
}
