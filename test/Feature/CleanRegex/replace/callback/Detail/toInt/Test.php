...
class Test extends TestCase
{
    ...
    {
        // given
        Pattern::of('194')->replace('194')->callback(Functions::out($detail, ''));
        // when, then
    ...
    {
        // given
        Pattern::of('1abc')->replace('1abc')->callback(Functions::out($detail, ''));
        // when, then
    ...
    {
        // given
        Pattern::of('9')->replace('9')->callback(Functions::out($detail, ''));
        // then
    ...
    {
        // given
        Pattern::of('-\d+')->replace('-9223372036854775809')->callback(Functions::out($detail, ''));
        // then
