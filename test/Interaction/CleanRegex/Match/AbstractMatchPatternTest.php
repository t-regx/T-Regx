...
class AbstractMatchPatternTest extends TestCase
{
    ...
    {
        // given
        $pattern = new MatchPattern(Internal::pcre('/\d+/'), new StringSubject('Foo 1 Bar 34 Lorem 42 Ipsum'));
    ...
    {
        // given
        $pattern = new MatchPattern(Internal::pcre('/\d+s?/'), new StringSubject('One number 9 large, Two number 45s'));
