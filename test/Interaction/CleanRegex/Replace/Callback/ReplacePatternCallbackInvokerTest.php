...
class ReplacePatternCallbackInvokerTest extends TestCase
{
    ...
    public function shouldInvokeCallback()
    {
        ...
        $invoker = new ReplacePatternCallbackInvoker(Internal::pattern('[0-9]+'), new StringSubject($subject), 2, new DefaultStrategy(), new IgnoreCounting());
    ...
    public function shouldInvokeUpToLimit()
    {
        ...
        $invoker = new ReplacePatternCallbackInvoker(Internal::pattern('[0-9]+'), new StringSubject($subject), 3, new DefaultStrategy(), new IgnoreCounting());
    ...
    {
        // given
        $invoker = new ReplacePatternCallbackInvoker(Internal::pcre('//'), new StringSubject(''), 0, new DefaultStrategy(), new IgnoreCounting());
