...
use Test\Fakes\CleanRegex\Internal\NoAutoCapture\ThrowGroupAutoCapture;
...
class PatternEntitiesTest extends TestCase
{
    ...
    {
        // given
        $asEntities = new PatternEntities(new SubpatternFlagsStringPattern('\0', SubpatternFlags::empty()), new ThrowGroupAutoCapture(), new ThrowPlaceholderConsumer());
    ...
    {
        // given
        $asEntities = new PatternEntities(new SubpatternFlagsStringPattern('\K', SubpatternFlags::empty()), new ThrowGroupAutoCapture(), new ThrowPlaceholderConsumer());
    ...
    {
        // given
        $asEntities = new PatternEntities(new SubpatternFlagsStringPattern('[]]]', SubpatternFlags::empty()), new ThrowGroupAutoCapture(), new ThrowPlaceholderConsumer());
    ...
    {
        // given
        $asEntities = new PatternEntities(new SubpatternFlagsStringPattern('[:alpha:]', SubpatternFlags::empty()), new ThrowGroupAutoCapture(), new ThrowPlaceholderConsumer());
    ...
    {
        // given
        $asEntities = new PatternEntities(new SubpatternFlagsStringPattern('[F\]O]', SubpatternFlags::empty()), new ThrowGroupAutoCapture(), new ThrowPlaceholderConsumer());
    ...
    {
        // given
        $asEntities = new PatternEntities(new SubpatternFlagsStringPattern('[01[:alpha:]%]', SubpatternFlags::empty()), new ThrowGroupAutoCapture(), new ThrowPlaceholderConsumer());
