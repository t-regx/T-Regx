...
class MatchPatternTest extends TestCase
{
    ...
    {
        // given
        $pattern = new MatchPattern(InternalPattern::standard('([A-Z])?[a-z]+'), '_ Nice matching pattern');
    ...
    {
        // given
        $pattern = new MatchPattern(InternalPattern::standard('(?<group>[A-Z])?(?<group2>[a-z]+)'), '__ Nice matching pattern');
