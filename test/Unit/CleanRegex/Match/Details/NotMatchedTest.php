<?php
namespace Test\Unit\CleanRegex\Match\Details;
...
class NotMatchedTest extends TestCase
{
    ...
    public function shouldNotCastToString()
    {
        ...
        $this->expectExceptionMessage('Object of class CleanRegex\Match\Details\NotMatched could not be converted to string');
