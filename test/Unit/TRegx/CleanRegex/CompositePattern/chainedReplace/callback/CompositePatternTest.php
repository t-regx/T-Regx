<?php
namespace Test\Unit\TRegx\CleanRegex\CompositePattern\chainedReplace\callback;
...
class CompositePatternTest extends TestCase
{
    ...
    public function test(int $times, string $expected)
    {
        ...
        // when
        $replaced = $pattern->chainedReplace("Do you think that's air you're breathing now?")->callback(function () {
            return '__';
        });
