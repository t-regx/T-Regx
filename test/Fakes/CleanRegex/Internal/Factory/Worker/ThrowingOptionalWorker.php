<?php
namespace Test\Fakes\CleanRegex\Internal\Factory\Worker;

use Test\Fakes\CleanRegex\Internal\Factory\Optional\ConstantThrowOptionalWorker;
use TRegx\CleanRegex\Internal\Factory\Optional\OptionalWorker;
use TRegx\CleanRegex\Internal\Factory\Worker\StreamWorker;

class ThrowingOptionalWorker implements StreamWorker
{
    /** @var \Throwable */
    private $fluent;
    /** @var \Throwable */
